...
names <- c("age","workclass","fnlwgt","education","educationnum","maritalstatus","occupation","relationship","race","sex","capitalgain","capitalloss","hoursperweek","nativecountry", "salary")  # vector of column names
...
xx$workclass <- gsub("?",NA,xx$workclass, fixed = TRUE)  
